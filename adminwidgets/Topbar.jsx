...
export default function Topbar({title}) {
  return (
    <div className='w-full flex justify-between items-center p-5 backdrop-blur-sm sticky top-0 sm:right-0'>
        ...
        <Link href={'/login'} className='cursor-pointer hover:opacity-75 rounded-lg border border-[#00eaff] text-col w-[70px] h-[30px] flex justify-center items-center text-sm font-bold'>Logout</Link>
